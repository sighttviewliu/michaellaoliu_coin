...
#ifndef MICHAELLAOLIU_QT_SENDCOINSDIALOG_H
#define MICHAELLAOLIU_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending michaellaolius */
...
#endif // MICHAELLAOLIU_QT_SENDCOINSDIALOG_H
