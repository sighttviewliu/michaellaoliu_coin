...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<MichaellaoliuAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_michaellaoliu-qt -platform xcb      # Linux
//     src/qt/test/test_michaellaoliu-qt -platform windows  # Windows
//     src/qt/test/test_michaellaoliu-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = MichaellaoliuUnits::formatWithUnit(unit, balance, false, MichaellaoliuUnits::separatorAlways);
    ...
    // Amount input
    MichaellaoliuAmountField* amountInput = receiveCoinsDialog.findChild<MichaellaoliuAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: michaellaoliu:")) != -1);
