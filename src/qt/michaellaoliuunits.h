...
#ifndef MICHAELLAOLIU_QT_MICHAELLAOLIUUNITS_H
#define MICHAELLAOLIU_QT_MICHAELLAOLIUUNITS_H
...
/** Michaellaoliu unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MichaellaoliuUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MichaellaoliuUnits(QObject *parent);

    /** Michaellaoliu units.
      @note Source: https://en.michaellaoliu.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MLL,
...
typedef MichaellaoliuUnits::Unit MichaellaoliuUnit;

#endif // MICHAELLAOLIU_QT_MICHAELLAOLIUUNITS_H
