...
#ifndef MICHAELLAOLIU_TEST_SCRIPTNUM10_H
#define MICHAELLAOLIU_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Michaellaoliu Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MICHAELLAOLIU_TEST_BIGNUM_H
