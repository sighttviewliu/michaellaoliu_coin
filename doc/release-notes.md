Michaellaoliu Core version 0.16.1 is now available from:

  <https://michaellaoliucore.org/bin/michaellaoliu-core-0.16.1/>
...
- #12843 `df38b13` Test starting michaellaoliud with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure michaellaoliud processes are cleaned up when tests end (sdaftuar)
