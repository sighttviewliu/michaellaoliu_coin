...
This document provides guidelines for internationalization of the Michaellaoliu Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `michaellaoliu_en.ts` remains unchanged.
