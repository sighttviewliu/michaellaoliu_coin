...
class BIP66Test(MichaellaoliuTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # michaellaoliud is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and michaellaoliud produces more specific reject
            # reasons.
