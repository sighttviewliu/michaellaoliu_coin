Michaellaoliu Core version 0.13.2 is now available from:

  <https://michaellaoliu.org/bin/michaellaoliu-core-0.13.2/>
...
- #8908 `4a974b2` Update michaellaoliu-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow michaellaoliu-tx to create v2 transactions (MLLdrak)
