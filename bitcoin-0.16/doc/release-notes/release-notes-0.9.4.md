Michaellaoliu Core version 0.9.4 is now available from:

  https://michaellaoliu.org/bin/0.9.4/
...
this update is incompatible with the Michaellaoliu system and could lead to consensus
forks.

Michaellaoliu Core released binaries from https://michaellaoliu.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~michaellaoliu/+archive/ubuntu/michaellaoliu
- A third-party or self-compiled Michaellaoliu Core

upgrade to Michaellaoliu Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
