Michaellaoliu Core version 0.9.2.1 is now available from:

  https://michaellaoliu.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MLL to 0.01 MLL
...
- Fix "Start michaellaoliu on system login"
