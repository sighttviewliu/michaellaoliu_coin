...
By default, michaellaoliud will dump mempool on shutdown and
...
class MempoolPersistTest(MichaellaoliuTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give michaellaoliud a second to reload the mempool
        ...
        self.log.debug("Prevent michaellaoliud from writing mempool.dat to disk. Verify that `savemempool` fails")
