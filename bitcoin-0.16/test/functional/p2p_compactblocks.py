...
# TestNode: A peer we use to send messages to michaellaoliud, and store responses.
...
class CompactBlocksTest(MichaellaoliuTestFramework):
    ...
    # This test actually causes michaellaoliud to (reasonably!) disconnect us, so do this last.
    ...
    # michaellaoliud's choice of nonce.
    ...
    # Test that michaellaoliud requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for michaellaoliud to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # michaellaoliud will not send blocktxn responses for blocks whose height is
