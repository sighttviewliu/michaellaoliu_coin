#!/usr/bin/env python3
# Copyright (c) 2018 The Michaellaoliu Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting michaellaoliu with -h works as expected."""
import subprocess

from test_framework.test_framework import MichaellaoliuTestFramework
from test_framework.util import assert_equal

class HelpTest(MichaellaoliuTestFramework):
    ...
    def run_test(self):
        self.log.info("Start michaellaoliu with -h for help text")
        ...
        self.log.info("Start michaellaoliu with -version for version information")
