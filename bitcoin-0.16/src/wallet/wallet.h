...
#ifndef MICHAELLAOLIU_WALLET_WALLET_H
#define MICHAELLAOLIU_WALLET_WALLET_H
...
public:
     ...
     * on this michaellaoliu node, and set to 0 for transactions that were created
...
#endif // MICHAELLAOLIU_WALLET_WALLET_H
