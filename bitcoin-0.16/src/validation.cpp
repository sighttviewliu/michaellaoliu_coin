...
#if defined(NDEBUG)
# error "Michaellaoliu cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Michaellaoliu Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MLL additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    //michaellaoliu
    CAmount nSubsidy = 50*10000 * COIN;
...
void ThreadScriptCheck() {
    RenameThread("michaellaoliu-scriptch");
