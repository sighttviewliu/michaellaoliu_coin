    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return MichaellaoliuUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, MichaellaoliuUnits::separatorNever);
            else
                return MichaellaoliuUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+MichaellaoliuUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
